...
#define APP_NAME_STR_LEN 80
    ...
    // The server has a number of global objects that are available to all clients. 
    // These objects typically represent an actual object in the server (for example, 
